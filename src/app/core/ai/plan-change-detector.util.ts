...
/** Canonical, order-insensitive string from a PlanSessionOptions snapshot. */
...
/** Change ratio between two snapshots. 0 = identical, 1 = completely different. */
...
/** Returns true when change ratio ≤ 20%. */
...
/** Extracts PlanSessionOptions from a plan request. */
export function toSessionOptions(req: {
  ...
  return {
    selectedOptionTitle:      req.selectedOption.title,
    selectedOptionSummary:    req.selectedOption.summary,
    selectedOptionHighlights: req.selectedOption.highlights,
